...
export function AppRoutes() {
  return (
    <Routes>
      ...
      <Route element={<ProtectedRoute />}><Route element={<AppLayout />}><Route path="/app" element={<AuthenticatedHomePage />} /><Route path="/app/leads" element={<LeadsPage />} /><Route path="/app/leads/:id" element={<LeadDetailsPage />} /></Route></Route>
