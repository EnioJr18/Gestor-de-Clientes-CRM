...
export const dashboardMetricsSchema = z.object({ total_leads: nonNegativeInteger, created_today: nonNegativeInteger, created_in_period: nonNegativeInteger, converted_in_period: nonNegativeInteger, conversion_rate: z.number().finite().nonnegative() })
